    ...
    <div>
      <div>
        <div className="row">
          <div className="col l1 s12 center hide-on-med-and-down">
            <ul>
              ...
              <br />
              <li className="tab">
                <a className="active" href="/user/ptraderoom.html?menu=binary">
                  <br />
              ...
              <br />
              <li className="tab">
                <a className href="/user/ptraderoom.html?menu=open">
                  <br />
              ...
              <br />
              <li className="tab">
                <a className href="/user/ptraderoom.html?menu=closed">
                  <br />
          ...
          <div className="col l11 s12">
            <div className="row ">
              ...
              <div className="col l2 s6 app-line" style={{ textAlign: 'right' }}>
                <a href="/user/index.html" style={{ display: 'inline-block' }}>
                  <span
        ...
        <div className="fixed-footer bg hide-on-large-only">
          <ul className="tabs">
            <li className="tab">
              <a title="Home" href="/user/index.html">
                <span className="material-icons notranslate">home</span>
                <span className="hide-on-small-only">Home</span>
              </a>
            </li>
            <li className="tab">
              <a title="Binary Options" className="active" href="/user/ptraderoom.html?menu=binary">
                <span className="material-icons notranslate">access_time</span>
                <span className="hide-on-small-only">Binary Options</span>
              </a>
            </li>
            <li className="tab">
              <a title="Open Trades" className href="/user/ptraderoom.html?menu=open">
                <span className="material-icons notranslate">hourglass_top</span>
                <span className="hide-on-small-only">Open Trades</span>
              </a>
            </li>
            <li className="tab">
              <a title="Closed Trades" className href="/user/ptraderoom.html?menu=closed">
                <span className="material-icons notranslate">hourglass_full</span>
