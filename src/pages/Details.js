        ...
        <div className="col l4 s12 offset-l4">
          ...
          <div className="card-panel">
            ...
            <form autoComplete="off">
              ...
              <div className="input-field">
                <input type="text" id="state" name="state" maxLength={300} inputMode="text" required defaultValue />
                <label className="active" htmlFor="state">
                  state
                </label>
              </div>
              <div className="input-field">
                <input type="text" id="city" name="city" maxLength={300} inputMode="text" required defaultValue />
